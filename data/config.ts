...
export const TRUSTED_CLIENTS: TrustedClient[] = [
  ...
  { name: 'Murphy Business Advisors', logo: '/images/clients/Murphy.png', category: 'Business Brokerage', abbr: 'MBA' },
  { name: 'Sunbelt Business Brokers', logo: '/images/clients/sunbelt.svg', category: 'Business Brokerage', abbr: 'SBB' },
  { name: 'V R Business Brokers', logo: '/images/clients/vrbuisness.webp', category: 'Business Mergers', abbr: 'VR' },
  { name: 'BizEx Business Brokers', logo: '/images/clients/Bizex.png', category: 'Business Sales', abbr: 'BizEx' },
  { name: 'Green&Co Business Advisors', logo: '/images/clients/Green-Co-Logo.png', category: 'M&A Advisors', abbr: 'G&Co' },
  { name: 'Pacific Mergers and Acquisitions', logo: '/images/clients/pacific-ma.svg', category: 'M&A Sourcing', abbr: 'PMA' },
  { name: 'Business Brokers Florida', logo: '/images/clients/bbf.png', category: 'Broker Association', abbr: 'BBF' },
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Currently, BrokerLeadz specializes in supporting licensed business brokers, M&A advisors, and exit planners across North America (United States & Canada), where our dialers and data operate with maximum precision.',
  },
  {
    id: 'faq-6',
